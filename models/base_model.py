#!/usr/bin/python3
"""
This module includes the BaseModel class
"""
...
class BaseModel:
    """This is the BaseModel class, future classes will inherit from this"""
    if models.storage_t == "db":
    ...
    def to_dict(self):
        """This method returns a dictionary that
        contains all keys/values of the instance"""
